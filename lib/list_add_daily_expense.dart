...
class ListDailyExpense extends StatefulWidget {
  const ListDailyExpense({super.key});

  @override
  State<ListDailyExpense> createState() => _ListDailyExpenseState();
}

class _ListDailyExpenseState extends State<ListDailyExpense> {
