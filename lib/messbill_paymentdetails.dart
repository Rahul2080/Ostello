...
class View_messbill_Paid_Rent extends StatefulWidget {
  const View_messbill_Paid_Rent({super.key});

  @override
  State<View_messbill_Paid_Rent> createState() =>
      _View_messbill_Paid_RentState();
}

class _View_messbill_Paid_RentState extends State<View_messbill_Paid_Rent> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("View Paid Mess Bill Details"),
...
//floating action button
      ...
      body: StreamBuilder(
        stream: pay.snapshots(),
        builder: (context, AsyncSnapshot snapshot) {
          if (snapshot.hasData) {
            return ListView.builder(
              itemCount: snapshot.data!.docs.length,
              itemBuilder: (context, index) {
                final DocumentSnapshot paysnap = snapshot.data.docs[index];
                return Padding(
