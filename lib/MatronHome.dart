...
class MatronHome extends StatefulWidget {
  const MatronHome({super.key});

  @override
  State<MatronHome> createState() => _MatronHomeState();
}

class _MatronHomeState extends State<MatronHome> {
      ...
      drawer: Drawer(
        ...
        child: ListView(padding: EdgeInsets.zero, children: [
          ...
          ListTile(
              ...
              // title: Text('Profile'),
              onTap: () {
                Navigator.pushNamed(context, '/matronProfile');
              }),
          ...
          ListTile(
              ...
              textColor: Color.fromARGB(255, 255, 255, 236),
              onTap: () {
                Navigator.pushNamed(context, '/addMessbill');
              }),

          ListTile(
              leading: Icon(Icons.list_alt_rounded),
              iconColor: Color.fromARGB(255, 255, 255, 236),
              title: Text('View Messbill'),
              textColor: Color.fromARGB(255, 255, 255, 236),
              onTap: () {
          ...
          ListTile(
              ...
              textColor: Color.fromARGB(255, 255, 255, 236),
              onTap: () {
                Navigator.pushNamed(context, '/listDailyExpense');
              }),
          ...
          ListTile(
              ...
              textColor: Color.fromARGB(255, 255, 255, 236),
              onTap: () {
                Navigator.pushNamed(context, '/listrooms');
              }),
