...
class Matronlogin extends StatefulWidget {
  Matronlogin({super.key});

  @override
  State<Matronlogin> createState() => _MatronloginState();
}

class _MatronloginState extends State<Matronlogin> {
  ...
  void submit(BuildContext context) async {
    try {
      ...
      if (user.user == null) {
        ...
        Navigator.pushNamed(context, '/matronHome');
      }
    } catch (e) {
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.of(context as BuildContext).push(
                        MaterialPageRoute(builder: (ctx) => matronRegister()));
                  },
                  child: Text(
                    "Register",
                    style: TextStyle(fontSize: 20),
